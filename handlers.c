 ...
 * @size: Size specifier
 *
 * Return: Number ofoutputed  characters.
 */
 ...
 *
 * Return: Number of outputed characters.
 */
...
/**
 * write_unsgnd - outputs unsigned num
 * @is_negative: No. indicating negative num
 * @ind: start Index
 ...
 * @flags: Flgs
 * @padd: Characters for padding
 * @extra_c: extra charac
